...
<html>
    <head lang="en">
        ...
        <style>
            * {
            ...
            body {
                background-image: url("retrive_regionalfood.jpg");
            ...
            #foodid:focus, #regname:focus, #reg:focus, #fav:focus {
    ...
    <body>
    <h2 style="color: ivory;">Do you want to add your regional food to the portal ?</h2>
    <button id="btn1" onclick="myFunction()">Add Regional Food</button>
    <form id="form_container" action="regionalfood_insertion.php" method="POST">
        <h1>Insert Regioanal Food</h1>
        <label for="foodid"><b>Food Id</b></label><br>
        <input type="text" id="foodid" name="foodid" placeholder="Ex. r1" required><br>
        <label for="regname"><b>Regional Food</b></label><br>
        <input type="text" id="regname" name="regname" placeholder="Name" required><br>
    ...
    <script>
        ...
        <table id="regional">
            ...
            $sql = "SELECT food_id, name, region, flavours FROM regionalfood";
